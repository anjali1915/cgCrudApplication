...
export const encryptToken = (token) => {
    ...
    const IV = crypto.randomBytes(16); //Initialization vector unique every time for each encryption
    const cipher = crypto.createDecipheriv(ALGORITHM, Buffer.from(SECRET_KEY), IV); //Secret key in bytes form
