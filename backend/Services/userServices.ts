...
const userServices = {
    saveUser: async (firstName: string , lastNname: string, dob: string, mobileNumber: string, address: string)
    ...
    updateUser: async (firstName: string,lastName: string,dob :string,mobileNumber :string,address:string ,user_id: String| undefined)
    : Promise<QueryResult<User>>=>{
        return await pool.query(
